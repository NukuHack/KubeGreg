...
// Wetware tweaks
    ...
    greg.circuit_assembler('neuro_processing_unit')
...
// WIP: Dimensional Circuits
    ...
    greg.assembly_line('dimensional_processor_mainframe')
        .itemInputs('4x gtceu:infinity_frame', '16x gfs:dimensional_processor_computer', '32x gfs:complex_smd_capacitor',
            ...
            '32x gfs:hyperdynamic_ram_chip', '32x gtceu:polyethyl_cyanoacrylate_foil', '8x gtceu:ruthenium_trinium_americium_neutronate_double_wire', '4x gtceu:double_holmium_plate') // could replace with omnium frame
        .inputFluids('gtceu:soldering_alloy 1152')
...
// Monic Circuits
    ...
    greg.assembly_line('monic_processor_mainframe')
        .itemInputs('8x gtceu:monium_frame', '2x gfs:monic_processing_unit', '16x gfs:monic_processor_computer', '64x gfs:complex_smd_capacitor', '64x gfs:complex_smd_transistor',
            ...
            '64x gfs:hyperdynamic_ram_chip', '64x gtceu:polyethyl_cyanoacrylate_foil', '64x gfs:quantum_soc_chip', '4x gtceu:double_infinity_plate', '8x gtceu:sculk_superconductor_double_wire') // could replace with omnium frame
        .inputFluids('gtceu:soldering_alloy 1152')
