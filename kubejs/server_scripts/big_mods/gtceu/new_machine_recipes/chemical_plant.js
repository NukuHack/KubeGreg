...
ServerEvents.recipes(event => {
    ...
    greg.assembly_line('chemical_plant_controller')
    ...
    greg.chemical_plant('fluoroantimonic_acid')
    ...
    greg.chemical_plant('polybenzimidazole_with_phenol')
    ...
    greg.chemical_plant('polybenzimidazole_without_phenol')
    ...
    greg.chemical_plant('sulfuric_acid')
    ...
    greg.chemical_plant('naquadah_line')
