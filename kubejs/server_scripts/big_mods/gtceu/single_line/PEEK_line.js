ServerEvents.recipes(event => {
    ...
    greg.large_chemical_reactor('4_fluorobenzoyl_chloride_process')
    ...
    greg.large_chemical_reactor('hydroquinone_process')
    ...
    greg.large_chemical_reactor('disodium_salt_of_hydroquinone_process')
    ...
    greg.large_chemical_reactor('carbon_acid_to_sodium_bicarbonate_dust')
    ...
    greg.electrolyzer('sodium_bicarbonate_to_soda_ash_dust')
    ...
    greg.large_chemical_reactor('peek_process')
    ...
    greg.chemical_plant('effortless_peek_process')
    ...
    // PEEK usages
    greg.chemical_reactor('plastic_boards_peek')
    ...
    greg.large_chemical_reactor('plastic_boards_peek')
        .itemInputs('gtceu:polyether_ether_ketone_plate', '4x gtceu:copper_foil')
        .inputFluids('gtceu:sulfuric_acid 250')
        .itemOutputs('16x gtceu:plastic_circuit_board')
        .duration(500)
