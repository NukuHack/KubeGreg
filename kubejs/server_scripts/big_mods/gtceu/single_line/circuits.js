ServerEvents.recipes(event => {
    ...
    const CircuitFluids = {
        matter: {
            'circuit_board': ['gtceu:omnium 144'],
    ...
    craftingDetails.forEach(([type, tier], index_stuff) => {
        procTiers.forEach((name, index) => {
            ...
            let [smd_type, ram_type, soc_type, chip_type, multi, small_multi] = MatTypesHelp[tier];
