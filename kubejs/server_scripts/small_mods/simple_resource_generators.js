ServerEvents.recipes(event => {
    ...
    event.replaceInput({output: "simple_resource_generators:raw_conversion_generator"}, "#c:raw_ores", "minecraft:furnace");
    event.replaceInput({output: "simple_resource_generators:simple_ore_generator_placement"}, "#c:raw_ores", "minecraft:furnace");
