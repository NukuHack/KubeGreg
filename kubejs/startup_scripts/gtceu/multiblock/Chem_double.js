...
GTCEuStartupEvents.registry('gtceu:machine', event => {
    event.create('chemical_plant', 'multiblock')
        ...
        .pattern(definition => FactoryBlockPattern.start()
            ...
            .aisle('HFFFH', 'FPPPF', ' FPF ', ' MPM ', ' FPF ', 'FEEEF')
            .aisle('HFFFH', 'FPPPF', ' FFF ', ' MMM ', ' FFF ', 'FEEEF')
            ...
            .where('H', Predicates.blocks(GTBlocks.CASING_TEMPERED_GLASS.get()))
            .where('M', Predicates.blocks(GTBlocks.FIREBOX_TUNGSTENSTEEL.get()))
